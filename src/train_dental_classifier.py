"""
Dental Disease Classification Model Training Script
EfficientNet-B2 사용 (안구 모델과 동일한 구조)
"""
import torch
...
def main():
    # 설정
    DATA_DIR = "data/dog_dental_classification"  # YOLO에서 변환된 분류 데이터
    SAVE_DIR = "models/dental_classifier"
    BATCH_SIZE = 32
    IMG_SIZE = 224
    EPOCHS = 50
    LEARNING_RATE = 1e-4
    ...
    writer = SummaryWriter(f'runs/dental_classifier')
    ...
    plot_confusion_matrix(val_labels, val_preds, list(idx_to_class.values()), 
